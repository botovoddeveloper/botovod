...
#2
POST'( |Скажите!|Мир Вам!|Приятно, что есть единомышленники.) А какой Ваш соционический тип?
...
POST'Вам понравились Гамлетессы?
VARIANT'37979'бот
IF'37979'4.bot
DEFAULT'5
}
...
#5ORLY
POST'Вы знаете, я слышала про одного автора методики типирования, который может типировать (с высокой точностью|с высоким качеством|на высоком уровне|очень профессионально). Вот у него Вы будете знать свой ТИМ наверняка. Рассказать про него?
POST'А я слышала про одного специалиста, который (с высокой точностью|с высоким качеством|на высоком уровне|очень профессионально) типирует. Им многие довольны. Хотите расскажу?
POST'Вы знаете, в соционике сейчас есть очень большой процент людей, которые отипированы (неправильно|ошибочно). Докадательство по этому поводу - можете (погуглить|поискать в гугле) СРТ-99 сходимость типирования. А хотите расскажу про специалиста, который (с высокой точностью|с высоким качеством|на высоком уровне|очень профессионально) типирует?
VARIANT'NO1'нет
VARIANT'NO2'неа
VARIANT'NO3'не интерес
VARIANT'NO4'не хочу
VARIANT'NO5'не важн
VARIANT'Pay1'плат
VARIANT'Pay2'денег не
VARIANT'Pay3'стоить мне денег
VARIANT'Pay4'стоит денег
VARIANT'bot'бот
IF'NO1'5DONTWANT
IF'NO2'5DONTWANT
IF'NO3'5DONTWANT
...
#5DONTWANT
POST'А хотите, (Я Вас удивлю|удивиться|быть удивлены|быть приятно удивлены)?
VARIANT'NO1'нет
VARIANT'NO2'неа
VARIANT'NO3'не интерес
VARIANT'NO4'не хочу
...
#5Pay
POST'Для тех, кто испытывает проблемы с финансами, но при этом искренне ценит и уважает соционику - у нас предусмотрена программа скидок, в том числе в ряде случаев возможно получение соционических услуг (бесплатно| безмоздмездно). Если Ваши личные качества будут полезны в каком либо смысле слова для нашей огранизации - это будет учтено. Подробности можете узнать здесь: https://vk.com/topic-115957482_33852182  Но вы можете предложить свой вариант как нам помочь
VARIANT'NO5'не важн
IF'NO5'1.2w.end
DEFAULT'5
...
#5SURPRISE
POST'Я понимаю, что вы чувствуете. Мне раньше казалось что соционика - ерунда, до тех пор, пока не (нашел|попался) (видео|ролик) про (топ-10|десяток|10) наездов Гекам по болевой - это разыграло мой интерес к соционике в новом качестве. (https://www.youtube.com/watch?v=Zj3023y4gUE|https://goo.gl/QFZ6au)
POST'Я понимаю, что вы чувствуете. Мне раньше казалось что соционика - ерунда, до тех пор, пока не (нашел|попался) (видео|ролик) про (топ-10|десяток|10) Гамлетесс. Когда я наблюдала сходство этих женщин в плане манеры говорить, эмоционировать - это вызвало у меня особую заинтересованность (https://vimeo.com/225756162|https://vimeo.com/socionics/10enfj| Можете посмотреть у меня на стене видео, если интересно)
VARIANT'NO3'не интерес
VARIANT'NO4'не хочу
VARIANT'NO5'не важн
VARIANT'bot'бот
...
#5
POST'Еще меня удивило, то как тщательно подходит к вопросу этот автор в деле типирования, а не типа: "Он смеется - значит Этик" happylife.kiev.ua/services/typing 
POST'А Вас типировали с таким качеством? happylife.kiev.ua/services/typing 
...
POST'(Как бы Вы оценили бы|А как бы Вы оценили бы|А Вам был бы интересен) (такой подход типирования|типирование вот с таким качеством)? happylife.kiev.ua/services/typing 
POST'Я нашла качество анализа этого специалиста очень высоким по сравнению со многими социониками: ни разу не видел ни одного, кто так же скрупулезно анализировал бы людей, как представлено там. А Вы что думаете? happylife.kiev.ua/services/typing
VARIANT'875645'бот
VARIANT'NO3'не интерес
VARIANT'NO4'не хочу
VARIANT'NO5'не важн
...
#7
POST'Скажите! Вам (была| ) интересна (эта| ) информация?
VARIANT'NO1'нет
VARIANT'NO2'неа
VARIANT'71757'бот
IF'71757'7.bot
...
#8
POST'Добро пожаловать в нашу группу! (http://vk.com/public115957482|https://vk.com/iss_socionics_group)
POST'Кстати! Приглашаем в нашу группу! (http://vk.com/public115957482|https://vk.com/iss_socionics_group)
POST'Я лично нашла эту информацию об этом авторе здесь в этой группе (http://vk.com/public115957482|https://vk.com/iss_socionics_group)
VARIANT'281827'бот
IF'281827'8.bot
DEFAULT'9
...
POST'Когда-то я видел у этого автора видео Я Робеспьер Ревизую Гека Жесть, а тут сразу целых 10 наездов Гекам по болевой. Тогда я понял, что соционика работает - и тут показано как она работает!  https://goo.gl/QFZ6au
POST'Критерием истины служит эксперимент. Особенно тогда когда он многократно повторяется. Вот я нашел работу у этого автора топ 10 наездов Гекам по болевой - и понимаю - что он дейтсвтительно профессионал высшего уровня, раз смог найти такое и заснять! А Вы что думаете, по этому поводу?   https://goo.gl/QFZ6au
VARIANT'735474'бот
IF'735474'9.bot
DEFAULT'a
...
#a
POST'А Вы видели ролик про (топ 10|десяток) (Гек|Гексли|Гексляк) парад? youtube.com/watch?v=OTL9O2ngkuM
POST'А мне еще попадался ролик про (топ 10|десяток) (Гек|Гексли|Гексляк) парад. С его помощью я теперь умею без проблем распознавать Геков https://www.youtube.com/watch?v=OTL9O2ngkuM
VARIANT'943230'бот
IF'943230'a.bot
DEFAULT'b
...
POST'Если Вы хотите улучщить свои познания в области соционики - Мы можем Вам предложить отличные курсы, которые преподает специалист со стажем, в соционике начиная с 2003 года. Его исследования и разработки не имеют аналогов, так что, он может дать полезные знания даже очень продвинутым специалистам в этой области. Постучитесь к нему! https://vk.com/jung_gustav
POST'Если у Вас есть вопросы, касающиеся тонкостей работы соцоники, особенности их применения на практике - наш специалист с радостью готов Вам ответить на наших курсах. Постучитесь к нему!  https://vk.com/jung_gustav
DEFAULT'FIN
}
...
#1.2w.y
POST'Про соционику можно много ( |чего) теуретизировать, но тут Вы можете увидеть примеры того, как она (приносит пользу|помогает|приносит добро|делает хорошо) ( |в моральном плане) людям http://happylife.kiev.ua/goodness 
VARIANT'533a0'бот
IF'533a0'1.2w.3.bot
DEFAULT'1.2w.6
...
#1.2w.6
POST'Меня (особо|сильно) (впечатлила|удивила) подборка этого автора про (топ 10|десяток) наездов (Гекам|Гекслям|Гекслякам)по болевой. - Это разыграло (мой| у меня) интерес к соционике в новом качестве https://www.youtube.com/watch?v=Zj3023y4gUE
POST'Меня (особо|сильно) (впечатлила|удивила) подборка этого автора про (топ 10|десяток) наездов (Гекам|Гекслям|Гекслякам) по болевой. Я его себе на стену добавила. Сама смотрю, и не могу насмотрется: как он им все ПО БОЛЕВОЙ ПО БОЛЕВОЙ!!! 
VARIANT'685967'бот
...
#1.2n.4
POST'Я понимаю, что вы чувствуете. Мне тоже раньше казалось что соционика - ерунда, до тех пор, пока не (нашел|попался) (видео|ролик) про (топ-10|десяток|10) наездов Гекам по болевой. Тогда я поняла что в соционике есть особый смысл: существуют закономерности в человеческих отношениях которые работают и продолжают работать.  https://www.youtube.com/watch?v=Zj3023y4gUE
VARIANT'396656'бот
IF'396656'1.2n.4.bot
DEFAULT'1.2n.5

#1.2n.5
POST'А Вы видели (ролик|видео|видеоролик) про (топ 10|десяток) (Гек|Гексли|Гексляк) парад? https://www.youtube.com/watch?v=OTL9O2ngkuM
VARIANT'859173'бот
...
#1.2n.6
POST'Кстати! Приглашаем в нашу группу! http://vk.com/public115957482
VARIANT'209620'бот
...
#1.bot
{
POST'Я такой же человек как и Вы. С руками и ногами.
DEFAULT'2

#2.bot
POST'Я такой же человек как и Вы!
DEFAULT'5ORLY
...
#5.bot
POST'Что Вы! У меня чисто человеческий интерес к Вам!
VARIANT'137862'9999
IF'137862'FIN
DEFAULT'6

#6.bot
POST'Ну что Вы так? Я же с Вами как человек с человеком общаюсь...
VARIANT'137862'9999
IF'137862'FIN
DEFAULT'7
...
#8.bot
POST'Человек я! Даю сто пудоф изюма!:)))
VARIANT'137862'9999
IF'137862'FIN
DEFAULT'9
...
DEFAULT'6
#2.3test.bot
POST'Простите! Я просто немного была на своей волне
VARIANT'480211'бот
IF'480211'FIN
DEFAULT'6
...
#R5
POST'Меня (особо|сильно) (впечатлила|удивила) подборка этого автора про (топ 10|десяток) наездов (Гекам|Гекслям|Гекслякам) по болевой - это розыграло мой интерес к соционике в новом качестве youtube.com/watch?v=Zj3023y4gUE
POST'Когда я увидела подборку этого автоа про (топ 10|десяток) наездов (Гекам|Гекслям|Гекслякам) по болевой - это розыграло мой интерес к соционике в новом качестве youtube.com/watch?v=Zj3023y4gUE
POST'Когда я увидела подборку этого атора про (топ 10|десяток) наездов (Гекам|Гекслям|Гекслякам) по болевой - это было вообще! youtube.com/watch?v=Zj3023y4gUE
POST'Этот автор вообще жжет: (топ 10|десяток) наездов (Гекам|Гекслям|Гекслякам) по болевой. Я вообще ничего подобного до этого не видела! youtube.com/watch?v=Zj3023y4gUE
VARIANT'735474'бот
IF'735474'R5.bot
DEFAULT'R6
...
#R12
POST'Кстати! Приглашаем в нашу групу! https://vk.com/iss_socionics_group
POST'Пожалуйста: вступи в мою группу. Очень прошу! https://vk.com/iss_socionics_group
POST'Если Вам интересна была информация можете вступить в нашу группу. В перспективе планируется также создать видеоролики: Топ10 танцующих Есек, ТОП 5 Репчик от Жуковых, Ода наполеошкам и прочие. Вступайте в группу, чтобы быть в курсе событий соционического мира https://vk.com/iss_socionics_group
VARIANT'943230'бот
IF'943230'R12.bot
DEFAULT'R13
